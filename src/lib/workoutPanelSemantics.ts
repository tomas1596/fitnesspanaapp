...
export const WORKOUT_LOG_PANEL_SHELL = cn(
  ...
  "[html[data-brand='pink']_&]:border-pink-700/35 [html[data-brand='pink']_&]:bg-zinc-950/92",
  "dark:[html[data-brand='pink']_&]:border-pink-800/45 dark:[html[data-brand='pink']_&]:bg-zinc-950/95",
);
...
export const WORKOUT_LOG_INPUT = cn(
  ...
  "[html[data-brand='pink']_&]:border-pink-600/35 [html[data-brand='pink']_&]:bg-zinc-900/88",
  "dark:[html[data-brand='pink']_&]:border-pink-800/40 dark:[html[data-brand='pink']_&]:bg-zinc-900/80",
);
...
export const WORKOUT_LOG_INNER_CARD = cn(
  ...
  'dark:bg-muted/15',
  "[html[data-brand='pink']_&]:border-pink-700/30 [html[data-brand='pink']_&]:bg-zinc-900/55",
  "dark:[html[data-brand='pink']_&]:border-pink-800/35 dark:[html[data-brand='pink']_&]:bg-zinc-900/50",
);
...
export const WORKOUT_LOG_SUBTYPE_PILL_IDLE = cn(
  ...
  "[html[data-brand='pink']_&]:border-pink-600/35 [html[data-brand='pink']_&]:bg-zinc-900/90 [html[data-brand='pink']_&]:text-pink-200",
  "[html[data-brand='pink']_&]:hover:bg-zinc-800 [html[data-brand='pink']_&]:hover:text-pink-100",
  "dark:[html[data-brand='pink']_&]:border-pink-700/40 dark:[html[data-brand='pink']_&]:bg-zinc-900/85 dark:[html[data-brand='pink']_&]:text-pink-100",
);
...
export const WORKOUT_LOG_LIST_SURFACE = cn(
  ...
  "[html[data-brand='pink']_&]:border-pink-700/30 [html[data-brand='pink']_&]:bg-zinc-900/65",
  "dark:[html[data-brand='pink']_&]:border-pink-800/35 dark:[html[data-brand='pink']_&]:bg-zinc-900/55",
);
...
export const WORKOUT_LOG_GHOST_ACTION = cn(
  ...
  "[html[data-brand='pink']_&]:text-pink-300 [html[data-brand='pink']_&]:hover:bg-zinc-800/80",
  "dark:[html[data-brand='pink']_&]:text-fuchsia-200 dark:[html[data-brand='pink']_&]:hover:bg-pink-950/45",
);
...
export const WORKOUT_LOG_SECONDARY_BTN = cn(
  ...
  "[html[data-brand='pink']_&]:border-pink-500/40 [html[data-brand='pink']_&]:bg-zinc-900 [html[data-brand='pink']_&]:text-pink-400",
  "[html[data-brand='pink']_&]:hover:bg-zinc-800 [html[data-brand='pink']_&]:hover:text-pink-300",
);
